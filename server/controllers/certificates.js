...
const email = async (hashed, settings) => {
  ...
  let mailOptions = {
    ...
    <div style="width:100%;height:0;padding-bottom:100%;position:relative;"><iframe src="https://giphy.com/embed/LM9APuedFPR5YWSmhM" width="100%" height="100%" style="position:absolute" frameBorder="0" class="giphy-embed" allowFullScreen></iframe></div><p><a href="https://giphy.com/gifs/unibogazici-graduate-boun-bogazici-universitesi-LM9APuedFPR5YWSmhM">via GIPHY</a></p>
